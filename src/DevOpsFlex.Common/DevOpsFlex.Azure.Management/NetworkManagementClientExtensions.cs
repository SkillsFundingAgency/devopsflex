namespace DevOpsFlex.Azure.Management
{
    ...
    public static class NetworkManagementClientExtensions
    {
        ...
        public static async Task CheckCreateReservedIp(this NetworkManagementClient client, string ipName, string location)
        {
        ...
        /// <returns>The async <see cref="Task"/> wrapper.</returns>
        public static async Task CheckCreateReservedIp(this NetworkManagementClient client, AzureCloudService model)
        {
            Contract.Requires(client != null);
            ...
            await client.CheckCreateReservedIp(ipName, model.System.Location.GetEnumDescription());
        }
    }
}
