...
namespace DevOpsFlex.DSL
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides DevOpsFlex files
	/// The implementation is done in DevOpsFlexDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class DevOpsFlexDirectiveProcessor : DevOpsFlexDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public DevOpsFlexDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides DevOpsFlex files
	/// </summary>
	public class DevOpsFlexDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string DevOpsFlexDirectiveProcessorName = "DevOpsFlexDirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "DevOpsSystem";
		...
		/// </summary>
		private const string supportedDirectiveName = "DevOpsFlex";
		...
		/// Constructor
		/// </summary>
		public DevOpsFlexDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return DevOpsFlexDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::DevOpsFlex.DSL.DevOpsSystem));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::DevOpsFlex.DSL.DevOpsSystem));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "DevOpsSystem" + "RelativePathToTemplateRelativePath";
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"DevOpsFlex.DSL.DevOpsFlexDomainModel",
					};
