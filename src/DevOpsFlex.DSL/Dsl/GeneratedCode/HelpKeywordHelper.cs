...
namespace DevOpsFlex.DSL
{
	...
	/// </remarks>
	public partial class DevOpsFlexHelpKeywordHelper : DevOpsFlexHelpKeywordHelperBase 
	{
		private static DevOpsFlexHelpKeywordHelper helpKeywordHelper;
		
		/// <summary>
		/// Constructs a new DevOpsFlexHelpKeywordHelper.
		/// </summary>
		protected DevOpsFlexHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DevOpsFlexHelpKeywordHelper.
		/// </summary>
		public static DevOpsFlexHelpKeywordHelper Instance
		{
			get
			{
				if(helpKeywordHelper == null)
				{
					helpKeywordHelper = new DevOpsFlexHelpKeywordHelper();
				}
	...
	/// </summary>
	public abstract class DevOpsFlexHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DevOpsFlexHelpKeywordHelperBase.
		/// </summary>
		protected DevOpsFlexHelpKeywordHelperBase()
			: base() { }
		...
		{
			this.helpKeywords = new global::System.Collections.Generic.Dictionary<string, string>(1);
			this.helpKeywords.Add(@"DevOpsFlex.DSL.DevOpsAlert", @"fabrikam.minimalwpf.exampleElement");
		}
