...
namespace DevOpsFlex.DSL
{
	...
	/// </summary>
	internal partial class DevOpsFlexExplorer : DevOpsFlexExplorerBase
	{
		/// <summary>
		/// Constructs a new DevOpsFlexExplorer.
		/// </summary>
		public DevOpsFlexExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the DevOpsFlexExplorerToolWindow.
	/// </summary>
	internal abstract class DevOpsFlexExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new DevOpsFlexExplorerBase.
		/// </summary>
		protected DevOpsFlexExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.DevOpsFlexExplorerMenu;
			}
		}
		...
		{
			get { return global::DevOpsFlex.DSL.DevOpsSystem.DomainClassId; }
		}
